...
--
-- Table structure for table `mclk_artists`
--

DROP TABLE IF EXISTS `mclk_artists`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mclk_artists` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `id_lfm` varchar(50) DEFAULT NULL,
  `id_disc` bigint(20) DEFAULT NULL,
...
--
-- Dumping data for table `mclk_artists`
--

LOCK TABLES `mclk_artists` WRITE;
/*!40000 ALTER TABLE `mclk_artists` DISABLE KEYS */;
/*!40000 ALTER TABLE `mclk_artists` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `mclk_usersServicesProfiles_data` VALUES (23,17,'username','Sherlockness'),(24,17,'session_key','FXy6EEeTt8bydItBJrNEW6ig13kgvuP6'),(32,22,'token','uVbVIaTgYYTXmuJehpggTSyoZJSsoMvCHHdKePEA'),(33,22,'token_secret','gDjWWVtVqeHwMrIxOkxVpaEjJqYWHtDRYAOSTKFx'),(34,22,'username','Sherlockness');
...
INSERT INTO `mclk_users_servicesProfiles` VALUES (17,43,1),(22,43,2);
...
-- Dump completed on 2018-10-11  9:08:28
